...
% TODO: Insert comparison of MQTT vs. REST latency data here.

\subsubsection{Throughput Limits}
% TODO: Insert throughput results and congestion limits here.

\subsubsection{Energy Profile Comparison}
% TODO: Insert power consumption (PPK2) data here.

\subsection{Discussion}
% TODO: Discuss the implications of the results. Which protocol performed better for the specific use case of Plant Up!?
% TODO: Answer the Research Question based on the data.

\subsection{Conclusion}
% TODO: Summarize the findings and the final recommendation (e.g., Use MQTT for sensor updates, REST for user profile actions).
