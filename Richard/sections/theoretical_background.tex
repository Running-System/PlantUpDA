...
\begin{center}
    \includegraphics[width=0.8\textwidth]{images/ESP32 Deep Sleep Configuration.png}
    \captionof{figure}{ESP32 Deep Sleep Configuration}
    \label{fig:temp_image_deep_sleep}
\end{center}
...
\begin{center}
    \includegraphics[width=0.8\textwidth]{images/MQTT Publish Data Function.png}
    \captionof{figure}{MQTT Publish Data Function}
    \label{fig:temp_image_mqtt_pub}
\end{center}
...
\begin{itemize}
    \item \textbf{Statelessness}: The server retains no session information. Each request must contain authentication tokens (e.g., JWT) and all context. This simplifies the server-side architecture for ``Plant Up!'' but adds to the payload size per message.
...
\begin{center}
    \includegraphics[width=0.8\textwidth]{images/HTTPClient Transmission Pattern.png}
    \captionof{figure}{HTTPClient Transmission Pattern}
    \label{fig:temp_image_http}
\end{center}
