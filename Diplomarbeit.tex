...
\usepackage{titlesec}
% Remove 'Chapter X' prefix, show only the number and title, reduce top spacing
\titleformat{\chapter}[hang]{\sffamily\huge\bfseries}{\thechapter\quad}{0pt}{}
...
%-----------------------------------------------------------------
	...
	\renewcommand{\footrulewidth}{0.4pt}   % Linie über Fußzeile

	\renewcommand{\sectionmark}[1]{\markright{\thesection\ #1}}
	\renewcommand{\chaptermark}[1]{\markboth{\thechapter\ #1}{}}

	% Kopfzeile: Seitenzahl links, Autor rechts (wechselt pro Kapitel)
	\newcommand{\currentauthor}{}
	\lhead{\sffamily\sl\thepage}
	\rhead{\sffamily\sl\footnotesize \currentauthor}

	% Fußzeile: Klasse links, Seite X von Y Mitte, Datum rechts
...
\renewcommand{\currentauthor}{A. Sherzai, D. Jin, R. Onuoha, A. Behari}
\input{Allgemein/einleitung}

\renewcommand{\currentauthor}{Arun Sherzai}
\input{Arun/einfuehrung.tex}
\clearpage
\renewcommand{\currentauthor}{Abd-Ulrahman Behari}
\input{Abudi/einfuehrung.tex}
\clearpage
\renewcommand{\currentauthor}{Richard Onuoha}
\input{Richard/einfuehrung.tex}
\clearpage
\renewcommand{\currentauthor}{Dennis Jin}
