...
\begin{figure}[H]
    ...
    \caption{Physical Plant Up! sensor setup with ESP32-S3 microcontroller, external plant sensors, cabling, and supporting hardware components.}
...
\bottomrule
\end{tabular}
\caption{Bill of materials and approximate prototype cost of the Plant Up! sensor station (list prices including VAT, excluding shipping, accessed on April 8, 2026).}
\label{tab:bom_costs}
\end{table}
