...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{images/LiveDataHealth.png}
    \caption{Plant status overview in the Plant Up! application showing health score, individual sensor values, and AI-generated care recommendations via the Daily Mentor feature.}
...
\begin{figure}[H]
    ...
    \caption[Decision flow from sensor data to care recommendation (AI-generated).]{Simplified decision flow: sensor data is compared against plant-specific thresholds and classified into condition zones, which then trigger the corresponding care recommendation (AI-generated).}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{images/24HourHealth.png}
    \caption{Historical sensor data visualization in Plant Up! showing temperature readings over a 24-hour period. Users can switch between different sensors and time ranges to identify trends and patterns.}
    \label{fig:trend_chart}
\end{figure}

As illustrated in Figure~\ref{fig:trend_chart}, a 24-hour chart can reveal repeating daily peaks, such as afternoon heating near a window, or unusual drops from night ventilation. These patterns support long-term care decisions like relocating the plant or adjusting the watering schedule proactively.
