...
\begin{figure}[H]
    ...
    \caption[Decision flow from sensor data to care recommendation (generated with ChatGPT 4o, OpenAI).]{Simplified decision flow: sensor data is compared against plant-specific thresholds and classified into condition zones, which then trigger the corresponding care recommendation (generated with ChatGPT 4o, OpenAI).}
...
\begin{minipage}[t]{0.4\textwidth}
    \vspace{0pt}
    \centering
    \includegraphics[width=0.9\linewidth]{images/24HourHealth.png}
    \captionof{figure}{Historical sensor data visualization in Plant Up! showing temperature readings over a 24-hour period. Users can switch time ranges to identify trends and patterns.}
