...
Human perception of light conditions is similarly unreliable. The visual system adapts to changing brightness levels (light adaptation), which often leads to an overestimation of the usable light available in indoor environments \cite{frontiersLightAdaptation}. A room may appear bright to humans while still providing insufficient light for healthy plant growth.
...
This gap motivates the development of \textit{Plant Up!}, a low-cost IoT system that translates environmental sensor data into clear and actionable care recommendations.
