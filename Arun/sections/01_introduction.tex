...
This chapter establishes the foundation of the thesis by outlining the core challenges of indoor plant care and introducing the motivations behind the ``Plant Up!'' project. It further defines the central research question and context that guide the subsequent technical implementations.
