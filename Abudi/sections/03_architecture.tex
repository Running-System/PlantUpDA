...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{Abudi/figures/plantup_fig1_master_v2.png}
...
\begin{figure}[htbp]
    \centering
    \scalebox{1.25}{\IoTNavigator{1}{0}}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \scalebox{1.25}{\IoTNavigator{2}{0}}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \scalebox{1.25}{\IoTNavigator{5}{0}}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \scalebox{1.25}{\IoTNavigator{7}{0}}
\end{figure}
