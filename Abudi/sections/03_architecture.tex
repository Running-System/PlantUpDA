...
\begin{figure}[!ht]
    ...
    \caption{Master Architecture illustrating the chronological data pipeline: sensors, ESP32, Wi-Fi/MQTT, Cloud Ingestion, unified PostgreSQL database, Edge Functions/AI, and the React Native app. Source: Own illustration.}
...
\begin{wrapfigure}{R}{0.35\textwidth}
    ...
    \caption{Physical (Layer 1) and Connectivity (Layer 2) tiers of the Plant Up! telemetry pipeline. Source: Own illustration.}
    \vspace{-10pt}
\end{wrapfigure}
...
\begin{figure}[htbp]
    ...
    \caption{Highlight of the Ingestion Gateway within the architecture. Source: Own illustration.}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{Highlight of the Cloud Data Persistence layer within the architecture. Source: Own illustration.}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{Highlight of the Application and Collaboration layer within the architecture. Source: Own illustration.}
\end{figure}
