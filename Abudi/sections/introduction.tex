...
\begin{itemize}
    ...
    \item \textbf{Protocol Discussion:} Detailed comparison and trade-offs between MQTT and REST communication protocols will be addressed in the following chapter Evaluating MQTT vs. REST.
\end{itemize}
